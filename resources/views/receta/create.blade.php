...
<div class="container ">
    <h1>
        Recetas<small>[Agregar Productos]</small>
    </h1>
...
<div class="row text-center">
    <div class="col-md-offset col-md-6">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <label for="price">Tiempo</label>
                <input type="number" step="any" name="time" class="form-control" required placeholder="Ingrese su Nombre">
            </div>
            <div class="form-group col-md-6">
